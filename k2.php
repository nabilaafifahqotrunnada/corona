        ...
        <div class="container text-center">
            <div class="row">
                ...
                <br><br><br><br><br><br>
                    <h1>HASIL</h1>
                    <p>
                    <b>Gejala-gejala ini membutuhkan perhatian segera ! </b></p>
                    <p>Anda harus segera menelepon Rumah Sakit Terdekat, atau langsung pergi ke instalasi gawat darurat terdekat.</p>
            ...
            <div class="col-md-5 col-sm-12 h-25">
                    <img src="k2.png" alt="Buku" style="padding-top: 8vh" />
                </div>
        </div>
    </header>
    <footer>
