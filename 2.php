  ...
  <path d="M8 2.25c.909 0 3.188.685 4.254 1.022a.94.94 0 01.656.773c.814 6.424-4.13 9.452-4.91 9.452V2.25z"/>
        ...
        <div class="container text-left">
            ...
            <br><br><br><br><br><br><br><br><br><br>
                <button class="btn btn-light px-5 py-3 primary-btn" style="margin-left: 200px" onclick="location.href='k2.php';">
                        YA
                    </button>
                    <br><br><br><br>
                    <button class="btn btn-light px-5 py-3 primary-btn" style="margin-left: 185px" onclick="location.href='3.php';">
                        TIDAK
                    </button>
                </p>
        </div>
