  ...
  <path d="M8 2.25c.909 0 3.188.685 4.254 1.022a.94.94 0 01.656.773c.814 6.424-4.13 9.452-4.91 9.452V2.25z"/>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item active">
                            <a class="nav-link" href="logadmin.php">ADMIN
                            </a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="#tentang">ABOUT ME
                            </a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="#sumber">SUMBER
                            </a>
                        </li>
                        <li class="nav-item">
                            <button class="btn btn-outline-light px-5 py-2 primary-btn" onclick="location.href='register.php';">REGISTER</button>
                        </li>
                        <li class="nav-item">
                            <button class="btn btn-light px-5 py-2 primary-btn" onclick="location.href='login.php';">LOGIN</button>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-md-5 col-sm-12 h-25">
                    <img src="c.png" alt="Buku" style="padding-top: 15vh" />
                </div>
                <br><br><br><br><br><br>
                ...
                <br><br><br><br><br><br><br>
                    ...
                    <p>
                        Online Quick Self Check-up for Covid-19 everytime and anywhere
                    </p>
    ...
    <main class = "main">
            ...
            <div class="container text-center">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="pray">
                            <img src="n.jpg" alt="Pepustakaan" class="" />
                        </div>
                    </div>
                    <div class="col-md-4 col-8">
                        <div class="panel text-left">
                            <h1>About Me</h1>
                            <p class="pt-4">
                                Nabila Afifah Qotrunnada, asal Malang
                            </p>
                            <p>
                                dan merupakan Siswa SMK Telkom Malang
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="section-1" id="sumber">
            <div class="container text-center">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="pray">
                            <img src="who.png" alt="Pepustakaan" class="" width="100px" height="400px" style="margin: 30px;"/>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="pray">
                        <br><br>
                            <img src="kem.png" alt="Pepustakaan" class="" width="350px" height="350px" style="margin: 30px;" />
                            <br><br><br><br>
                        </div>
                    </div>
                </div>
