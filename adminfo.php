        ...
        <div class="container text-center">
            <div class="row">
                ...
                <br><br><br><br><br><br><br><br><br><br>
                    <h1>MATERI COVID-19</h1>
                    <p>
                        Quick Guide <b>for Admin</b>
                    </p>
            ...
            <div class="col-md-5 col-sm-12 h-25">
                    <img src="mas.png" alt="Buku" style="padding-top: 15vh" />
                </div>
        </div>
    </header>
    <main class = "main">
        <section class="section-1" id="a" style="background-color: #f7be16">
                ...
                <div class="numbers d-flex flex-md-row flex-wrap justify-content-center">
                            <div class="rect"style="background-color: white; border: black solid 20px;">
                                <div class="row">
                                    <div class="col-sm">
                                        <img src="p1.png" alt="" width="550px" height="750px" style="margin: 50px;">
                                        <img src="p2.png" alt="" width="550px" height="750px"style="margin: 50px;">
                                        <br>
                                        <img src="p3.png" alt="" width="500px" height="600px"style="margin: 50px;">
                                        <img src="p4.png" alt="" width="500px" height="600px"style="margin: 50px;">
                                        <br>
                                        <img src="p5.png" alt="" width="500px" height="600px"style="margin: 50px;">
                                        <img src="p6.png" alt="" width="500px" height="600px"style="margin: 50px;">
                                        <br>
                                        <img src="p7.png" alt="" width="500px" height="600px"style="margin: 50px;">
                                        <img src="p10.png" alt="" width="500px" height="600px"style="margin: 50px;">
                                        <br>
                                        <img src="p8.png" alt="" width="1000px" height="1200px"style="margin: 50px;"><br>
                                        <img src="p9.png" alt="" width="1000px" height="1200px"style="margin: 50px;">
                                    </div>
                                </div>
                            </div>
                            <br>
