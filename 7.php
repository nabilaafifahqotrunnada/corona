  ...
  <path d="M8 2.25c.909 0 3.188.685 4.254 1.022a.94.94 0 01.656.773c.814 6.424-4.13 9.452-4.91 9.452V2.25z"/>
        ...
        <div class="container text-left">
            <div class="row">
                ...
                <br><br><br>
                <h3> Apakah kamu bekerja di / pernah mengunjungi </h3>
                <h3> fasilitas publik / kesehatan yang berhubungan </h3>
                <h3> dengan pasien positif COVID-19 ? </h3>
                <br><br><br>
                <p>
            </div>
            <p>
            <br><br><br><br><br><br><br><br><br><br>
                <button class="btn btn-light px-5 py-3 primary-btn" style="margin-left: 200px" onclick="location.href='k4.php';">
                        YA
                    </button>
                    <br><br><br><br>
                    <button class="btn btn-light px-5 py-3 primary-btn" style="margin-left: 185px" onclick="location.href='k1.php';">
                        TIDAK
                    </button>
                </p>
        </div>
