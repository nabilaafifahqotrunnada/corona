  ...
  <path d="M8 2.25c.909 0 3.188.685 4.254 1.022a.94.94 0 01.656.773c.814 6.424-4.13 9.452-4.91 9.452V2.25z"/>
        ...
        <div class="container text-left">
            <div class="row">
                ...
                <h3> - Sulit bernafas </h3>
                <br><br><br>
                <p>
            </div>
            <p>
            <br><br><br><br><br><br><br><br><br><br>
                <button class="btn btn-light px-5 py-3 primary-btn" style="margin-left: 200px" onclick="location.href='4.php';">
                        YA
                    </button>
                    <br><br><br><br>
                    <button class="btn btn-light px-5 py-3 primary-btn" style="margin-left: 185px" onclick="location.href='4.php';">
                        TIDAK
                    </button>
                </p>
        </div>
    ...
    <script src="./main.js"></script>
                ...
                <br>
                <h3> - Nafas yang pendek saat istirahat </h3>
                <h3> - Ketidakmampuan untuk berbaring karena kesulitan bernafas</h3>
                <h3> - Kondisi kesehatan kronis yang anda alami dirasakan lebih berat karena kesulitan bernapas</h3>
                <br><br><br>
                <p>
            </div>
            <p>
            <br><br><br><br><br><br><br><br><br><br>
                <button class="btn btn-light px-5 py-3 primary-btn" style="margin-left: 200px" onclick="location.href='#koleksi';">
                        YA
                    </button>
                    <br><br><br><br>
                    <button class="btn btn-light px-5 py-3 primary-btn" style="margin-left: 185px" onclick="location.href='k';">
                        TIDAK
                    </button>
                </p>
        </div>
