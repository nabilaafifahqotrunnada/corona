  ...
  <path d="M8 2.25c.909 0 3.188.685 4.254 1.022a.94.94 0 01.656.773c.814 6.424-4.13 9.452-4.91 9.452V2.25z"/>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="eh.php">HOSPITAL
                        </a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="cc.php">CALL CENTER
                        </a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="info.php">INFORMATION
                        </a>
                    </li>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <br><br><br><br><br><br><br>
                    ...
                    <p>
                        Real Quick Self Check-Up
                    </p>
                    <button class="btn btn-light px-5 py-2 primary-btn" onclick="location.href='start.php';">
                        Start
                    </button>
            </div>
            <div class="col-md-5 col-sm-12 h-25">
                    <img src="k4.png" alt="Buku" style="padding-top: 10vh" />
                    <h3> TETAP PRODUKTIF #dirumahaja </h3>
                </div>    
        </div>
    </header>
    <footer>
