        ...
        <div class="container text-center">
            <div class="row">
                ...
                <br><br><br><br>
                    <h1>HASIL</h1>
                    <p>
                    <b>Sebagai tindakan pencegahan, diminta siapa saja yang mengalami gejala untuk tinggal di rumah selama 14 hari ! </b></p>
                    <p>untuk mencegah penyebaran, anda disarankan untuk tidak keluar ke tempat publik, tinggal dirumah saja dan tidak boleh ada tamu. 
                    Anda disarankan untuk menelepon call center, di mohon anda jangan berangkat ke UGD, rumah sakit, atau klinik, 
                    kecuali kalau gejala anda semakin buruk segera pergi ke dokter terdekat.</p>
            ...
            <div class="col-md-5 col-sm-12 h-25">
                    <img src="k3.png" alt="Buku" style="padding-top: 8vh" />
                </div>
        </div>
    </header>
    <footer>
