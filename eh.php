  ...
  <path d="M8 2.25c.909 0 3.188.685 4.254 1.022a.94.94 0 01.656.773c.814 6.424-4.13 9.452-4.91 9.452V2.25z"/>
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <br><br><br><br>
                    <button class="btn btn-light px-5 py-2 primary-btn" onclick="location.href='suma.php';">
                        SUMATERA
                    </button><br><br><br>
                    <button class="btn btn-light px-5 py-2 primary-btn" onclick="location.href='jawa.php';">
                        JAWA
                    </button><br><br><br>
                    <button class="btn btn-light px-5 py-2 primary-btn" onclick="location.href='kali.php';">
                        KALIMANTAN
                    </button><br><br><br>
                    <button class="btn btn-light px-5 py-2 primary-btn" onclick="location.href='sula.php';">
                        SULAWESI
                    </button><br><br><br>
                    <button class="btn btn-light px-5 py-2 primary-btn" onclick="location.href='bnn.php';">
                        BALI, NTB, NTT
                    </button><br><br><br>
                    <button class="btn btn-light px-5 py-2 primary-btn" onclick="location.href='kmp.php';">
                        KEP. MALUKU, PAPUA
                    </button><br><br><br>
            </div>
            <div class="col-md-5 col-sm-12 h-25">
                    <img src="eh.png" alt="Buku" style="padding-top: 10vh" />
                    <h3> Quick List of Emergency Hospital </h3>
                </div>    
        </div>
    </header>
    <footer>
