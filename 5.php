  ...
  <path d="M8 2.25c.909 0 3.188.685 4.254 1.022a.94.94 0 01.656.773c.814 6.424-4.13 9.452-4.91 9.452V2.25z"/>
        ...
        <div class="container text-left">
            <div class="row">
                ...
                <h3> Adakah hubungan / kontak langsung dengan orang yang baru bepergian ke negara / kota terjangkit 
                </h3>
                <br>
                <h3> (China, Italy, Iran, Korea Selatan, Prancis, Spanyol, Jerman, USA) </h3>
                <h3> (Jakarta, Bali, Solo, Yogyakarta, Pontianak, Manado, Bandung dll) </h3>
                <br>
                <h3> dalam 14 hari terakhir? </h3>
                <br><br><br>
                <p>
            </div>
            <p>
            <br><br><br><br><br><br><br><br><br><br>
                <button class="btn btn-light px-5 py-3 primary-btn" style="margin-left: 200px" onclick="location.href='k3.php';">
                    ...
                    <br><br><br><br>
                    <button class="btn btn-light px-5 py-3 primary-btn" style="margin-left: 185px" onclick="location.href='6.php';">
                        TIDAK
                    </button>
                </p>
        </div>
